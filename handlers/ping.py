...
@Client.on_message(command(["ping", "repo", "Dangerop", "alive"]) & filters.group & ~filters.edited & ~filters.private)
...
async def help(client: Client, message: Message):
    ...
    await message.reply_sticker("https://telegra.ph/file/ed1e4016b2209a6d219cb.jpg")
    jay = await message.reply_photo(
        photo=f"{PING_IMG}",
        caption=" Pinging...⚡ ",
    )
    await jay.edit_text(
        f"""<b> pong ping ! ⚡</b>\n  🏓 `{resp} ms`\n\n<b><u>{BOT_NAME} system stats:</u></b>\n\n✨ Uptime : {bot_uptime}\n🔮 Cpu : {cpu}%\n💫 Disk : {disk}%\n❤️ Ram : {mem} \n\n || ᴘᴏᴡᴇʀ ʙʏ [Qᴜᴇᴇɴ server](https://t.me/QN_Team_support) || """,
